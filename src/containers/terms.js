  ...
  render() {
    return (
      <div className={ styles.terms }>
        ...
        <p>
          <strong>These Terms of Service cover the provision of Snappy Ubuntu Apps by Canonical Group Limited ("Canonical", "us", "our" or "we") to you ("you" or "your") subject to and in accordance with these Terms of Service (the “Services”).</strong>
        </p>
        <p>
          Please read these Terms of Service carefully before you use the Services. By using Services, you agree to become bound by these Terms of Service. You may not use the Service for illegal or unauthorised purposes or otherwise in accordance with this Terms of Service.
        </p>
        <p>
        ...
        <p>
          <strong>
            The Service enables you to download and install snaps and software (“Software”) on Snappy Ubuntu Core.
          </strong>
        </p>
        <p>
          Details of the Services can be found here:  [insert link]
        </p>
        <p>
          Software will be available from the third party provider of the Software or from Canonical directly. If Software is provided by a third party then the third party’s end user licence agreement will apply (“<strong>Software Terms</strong>”). You are responsible for compliance with such Software Terms and we take no responsibility for such Software.
        </p>
        <p>
        ...
        <p>
          If you install Software on a public cloud or in an environment operated by a third party with which you have an account (e.g. Google, MS Azure or Amazon Web Services), your use of that service is subject to the terms of service you have agreed with them and that third party may levy additional charges on you for using their service. You are responsible for compliance with such terms of service and any such additional charges to the third party and we take no responsibility for such services or charges.
        </p>
        <h3>
          3. Account
        </h3>
        ...
        <ul>
          ...
          <li>not be located in or use the Services in an OFAC/EAR embargoed or sanctioned country or be on the U.S. Commerce Department’s Denied Persons List, Entity List, or Unverified List.</li>
        </ul>
        <p>
        ...
        <p>
          You will be provided with an account page. [Insert details of account page].
        </p>
        <p>
          You may cancel your account at any time through your account page.
        </p>
        <h3>
          4. End of Service
        </h3>
        ...
        <p>
          You may cancel your use of the Services by cancelling your account in accordance with section 3. Cancellation of your account will have the effect of cancelling your subscription to the Software.
        </p>
        <p>
          5. Fees
        </p>
        <p>
          You will be asked to enter your credit card details and to confirm your acceptance of these Terms of Service on creation of your account. We will only charge your credit card at the time of the use of the Service. [The Fees will be displayed on your account page, including payment details.]
        </p>
        <p>
        ...
        <p>
          Canonical is not responsible for any content or applications (including without limitation Software) provided by any third party. Should you reasonably believe that any third party content you access through the Services is in breach of any law, regulation or third party's rights, you should notify Canonical in writing at the address below. In doing so, please: (a) identify the material which you believe to be infringing; (b) identify what you believe this material infringes and why; (c) Provide your name, email address, address and telephone number; (d) confirm that you believe in good faith that this material is infringing a law or third party's rights and that, to the best of your knowledge, the information you are providing is correct; (e) identify if you are acting on behalf of the third party whose rights may have been infringed; and (f) provide your physical or electronic signature.
        </p>
        <h3>
          8. Personal data
        </h3>
